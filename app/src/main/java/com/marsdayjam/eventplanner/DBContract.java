...
public final class DBContract {
    ...
    /**
     * Table for event information and reference to the corresponding calendar and team databases.
     */
    ...
    /**
     * List of all Calendars including both personal and event for easier search of existing
     * calendars for view or delete.
     */
    ...
    /**
     * Table for storing events in CalendarOptions. Personal CalendarOptions database created on
     * employee creation and deleted on employee deletion. Event CalendarOptions database created on
     * creation of an event and deleted on event canceled or end date reached.
     */
